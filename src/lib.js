...
export const KEY_DATA_LINKS = "data.links";
export const KEY_DATA_LINK_TITLE = "data.link.title";
export const KEY_DATA_LINK_RESOURCE = "data.link.resource";
export const KEY_DATA_LINK_RESOURCE_ANIDB_ID = "data.link.resource.anidb.id";
export const KEY_DATA_LINK_RESOURCE_MANGAUPDATES_ID = "data.link.resource.mangaupdates.id";
export const KEY_DATA_LINK_RESOURCE_NOVELUPDATES_SLUG = "data.link.resource.novelupdates.slug";
export const KEY_DATA_LINK_RESOURCE_MYDRAMALIST_ID = "data.link.resource.mydramalist.id";
