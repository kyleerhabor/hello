// Resources
export const DATA_RESOURCE_VALUE_ANIDB_ANIME = 0;
export const DATA_RESOURCE_VALUE_MANGAUPDATES_SERIES = 1;
export const DATA_RESOURCE_VALUE_NOVELUPDATES_SERIES = 2;
export const DATA_RESOURCE_VALUE_MYDRAMALIST = 3;
export const DATA_RESOURCE_VALUE_EMAIL = 4;
export const DATA_RESOURCE_VALUE_GITHUB_USER = 5;
export const DATA_RESOURCE_VALUE_GITHUB_REPOSITORY = 6;
export const DATA_RESOURCE_VALUE_LINKEDIN_USER = 7;

// Date statuses
export const DATA_DATE_STATUS_VALUE_COMPLETED = 0;
export const DATA_DATE_STATUS_VALUE_PRESENT = 1;
export const DATA_DATE_STATUS_VALUE_EXPECTED = 2;
...
export const KEY_DATA_CV_CONTACT_ID = "data.cv.contact.id";
...
export const KEY_DATA_CV_EXPERIENCE_ID = "data.cv.experience.id";
...
export const KEY_DATA_CV_ACTIVITY_ID = "data.cv.activity.id";
...
export const KEY_DATA_CV_PROJECT_LINK_ID = "data.cv.project.link.id";
...
export const KEY_DATA_CV_EDUCATION_MAJOR_ID = "data.cv.education.major.id";
...
export const KEY_DATA_CV_EDUCATION_MINOR_ID = "data.cv.education.minor.id";
