...
;;; The AniList, GitHub, and Discord icons are from Simple Icons (https://simpleicons.org/). The icons from the icons'
;;; respective branding pages (or just source code, as was for AniList) vary too much between each other.
